  ...
  return (
    <div className="bg-[#f5f5f7]">
      ...
      <section className="relative overflow-hidden" style={{ background: buildHeroGradient(config) }}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24 md:py-44">
          <div className={`text-center transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-5 sm:mb-6 text-white text-balance">
              {config.heroTitle}
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-white/75 max-w-2xl mx-auto mb-8 sm:mb-12 leading-relaxed px-1">
              {config.heroDesc}
            </p>
